  ...
  return (
    <div className="frontpage-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', width: '100vw' }}>
      ...
      <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
        <button style={{ padding: '1rem 2rem', fontSize: '1rem', cursor: 'pointer' }} onClick={onUnderviserClick}>Underviser</button>
        <button style={{ padding: '1rem 2rem', fontSize: '1rem', cursor: 'pointer' }} onClick={onStuderendeClick}>Studerende</button>
      </div>
    </div>
  );
};
